...
//	private int raise;
	...
	public void setUpSalary() {
		upSalary = (ySalary / 100 * 10)+ySalary;
	}
	
	public void printResults (){
		System.out.printf("Employee %s %s will recieve 10 percent raise to theit yearly salary of: %.2f\n", getFirstN(),getLastN(),getySalary());
		System.out.printf("New yearly salary will be: %.2\n", getUpSalary());
