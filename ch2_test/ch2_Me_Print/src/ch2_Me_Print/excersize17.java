...
// from the user and displays the sum, average, product, smallest and largest of the numbers. 
...
public class excersize17 {
	...
	public static void main (String[] args) {
		...
		prod; // Multiplication of 3
		
		//Initialization of number variables:
	...
	System.out.print("Enter Third Number: ");
		...
		if (n1 == n2 && n2 == n3){
			...
			System.out.printf("%d is the largest number!", n1);
		} else if (n1 < n2 && n2 > n3){
			System.out.printf("%d is the largest number!", n2);
		}else if (n1 < n2 && n2 < n3){
			System.out.printf("%d is the largest number!", n3);
		}
	}
	}
